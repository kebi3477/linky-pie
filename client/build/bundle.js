...
var app = (function () {
	...
	function create_fragment$7(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(a, file$5, 40, 0, 1384);
			},
	...
	class Router extends SvelteComponentDev {
		constructor(options) {
			super(options);
			init(this, options, instance$5, create_fragment$5, safe_not_equal, { basepath: 6, url: 7, history: 8 });
	...
	const file$4 = "svelte\\Login\\Header.svelte";
	...
	function create_fragment$4(ctx) {
		...
		const block = {
			c: function create() {
				...
				t3 = space();
				a2 = element("a");
				a2.textContent = "block";
				attr_dev(a0, "href", "/");
				attr_dev(a0, "class", "login__button svelte-bgg4a0");
				add_location(a0, file$4, 4, 4, 107);
				attr_dev(a1, "href", "/join");
				attr_dev(a1, "class", "login__button svelte-bgg4a0");
				add_location(a1, file$4, 5, 4, 163);
				attr_dev(a2, "href", "/block");
				attr_dev(a2, "class", "login__button svelte-bgg4a0");
				add_location(a2, file$4, 6, 4, 224);
				attr_dev(header, "class", "login__header svelte-bgg4a0");
				add_location(header, file$4, 3, 0, 71);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	const file$3 = "svelte\\Login\\Login.svelte";
	...
	function create_fragment$3(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(div0, file$3, 30, 12, 753);
				attr_dev(div1, "class", "login__title--small title svelte-1jqmo63");
				add_location(div1, file$3, 31, 12, 821);
				...
				add_location(input0, file$3, 32, 12, 897);
			...
			m: function mount(target, anchor) {
				...
				if (!mounted) {
					dispose = [
						...
						listen_dev(input0, "keydown", /*handleEnter*/ ctx[3], false, false, false, false),
						listen_dev(input1, "input", /*input1_input_handler*/ ctx[5]),
						listen_dev(input1, "keydown", /*handleEnter*/ ctx[3], false, false, false, false),
	...
	function instance$3($$self, $$props, $$invalidate) {
		...
		return [id, password, login, handleEnter, input0_input_handler, input1_input_handler];
	}
	...
	const file$2 = "svelte\\Login\\Join.svelte";
	...
	/* svelte\Block\Block.svelte generated by Svelte v4.1.1 */

	const { console: console_1 } = globals;
	const file$1 = "svelte\\Block\\Block.svelte";
	...
	function create_fragment$1(ctx) {
		...
		let mounted;
		let dispose;
		let each_value = ensure_array_like_dev(/*blocks*/ ctx[1]);
		let each_blocks = [];
		...
		const block = {
			...
			m: function mount(target, anchor) {
				...
				if (!mounted) {
					dispose = [
						...
						listen_dev(input, "keydown", /*handleEnter*/ ctx[2], false, false, false, false),
						listen_dev(input, "paste", /*handlePaste*/ ctx[3], false, false, false, false)
					];
			...
			p: function update(ctx, [dirty]) {
				...
				if (dirty & /*blocks*/ 2) {
					each_value = ensure_array_like_dev(/*blocks*/ ctx[1]);
					let i;
	...
	function instance$1($$self, $$props, $$invalidate) {
		...
		async function createBlock(link) {
			await Fetch.post('/api/blocks', { title: '테스트', content: '본문 테스트', link });
			$$invalidate(0, url = '');
		}
		...
		Object.keys($$props).forEach(key => {
			if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Block> was created with unknown prop '${key}'`);
		});
		...
		return [url, blocks, handleEnter, handlePaste, input_input_handler];
	}
	...
	function create_default_slot(ctx) {
		...
		route0 = new Route({
				props: { path: "block", component: Block },
				$$inline: true
			});
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(main, file, 9, 0, 250);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
