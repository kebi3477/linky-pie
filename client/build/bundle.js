...
var app = (function () {
	...
	function create_fragment$5(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(a, file$3, 40, 0, 1384);
			},
	...
	class Router extends SvelteComponentDev {
		constructor(options) {
			super(options);
			init(this, options, instance$3, create_fragment$3, safe_not_equal, { basepath: 6, url: 7, history: 8 });
	...
	const file$2 = "svelte\\Login\\Header.svelte";
	...
	function create_fragment$2(ctx) {
		...
		const block = {
			c: function create() {
				...
				div0 = element("div");
				div0.textContent = "로그인";
				t1 = space();
				div1 = element("div");
				div1.textContent = "회원가입";
				attr_dev(div0, "class", "login__button svelte-bgg4a0");
				add_location(div0, file$2, 3, 4, 57);
				attr_dev(div1, "class", "login__button svelte-bgg4a0");
	...
	const file$1 = "svelte\\Login\\Login.svelte";
	...
	function create_fragment$1(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(div0, "class", "login__title title svelte-1jkkvv6");
				add_location(div0, file$1, 7, 12, 178);
				attr_dev(div1, "class", "login__title--small title svelte-1jkkvv6");
				add_location(div1, file$1, 8, 12, 246);
				attr_dev(input0, "type", "text");
				attr_dev(input0, "name", "id");
				attr_dev(input0, "id", "login__input-id");
				attr_dev(input0, "class", "login__input-id input svelte-1jkkvv6");
				add_location(input0, file$1, 9, 12, 322);
				attr_dev(input1, "type", "password");
				attr_dev(input1, "name", "pw");
				attr_dev(input1, "id", "login__input-pw");
				attr_dev(input1, "class", "login__input-pw input svelte-1jkkvv6");
				add_location(input1, file$1, 10, 12, 416);
				attr_dev(button, "class", "login__button svelte-1jkkvv6");
				add_location(button, file$1, 11, 12, 514);
				attr_dev(div2, "class", "login__wraper svelte-1jkkvv6");
				add_location(div2, file$1, 6, 8, 137);
				attr_dev(div3, "class", "login__content svelte-1jkkvv6");
				add_location(div3, file$1, 5, 4, 99);
				attr_dev(main, "class", "svelte-1jkkvv6");
				add_location(main, file$1, 3, 0, 64);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	function create_fragment(ctx) {
		...
		const block = {
			c: function create() {
				...
				add_location(main, file, 7, 0, 158);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
	...
	function instance($$self, $$props, $$invalidate) {
		...
		$$self.$capture_state = () => ({ Router, Link, Route, Login, url });
